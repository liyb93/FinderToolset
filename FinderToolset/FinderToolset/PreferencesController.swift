//
//  File Name:  PreferencesController.swift
...
class PreferencesController: NSViewController, PreferencePane {
    let preferencePaneIdentifier = Identifier.init("FinderToolset.general")
    let preferencePaneTitle = "通用"
    let toolbarItemIcon = NSImage.init(named: "general")!
    
    override var nibName: NSNib.Name? { "PreferencesController" }
...
extension PreferencesController {
    fileprivate struct Key {
        static let preference = "FinderToolset.preference"
    }
}
